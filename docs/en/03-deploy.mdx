...
All Terraform files are in the [`terraform/`](https://github.com/f5-sales-demo/origin-server/tree/main/terraform) directory. Clone the repository and deploy directly:
