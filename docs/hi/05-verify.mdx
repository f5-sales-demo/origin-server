...
title: सत्यापन
description: >-
  सभी नौ एप्लिकेशन एंडपॉइंट्स के लिए curl स्मोक टेस्ट, Docker कंटेनर हेल्थ चेक,
  nginx स्थिति सत्यापन, cloud-init लॉग निरीक्षण, और सामान्य समस्या निवारण चरण
sidebar:
  order: 5
i18n:
...
cloud-init पूर्ण होने के लिए 5--10 मिनट का समय देने के बाद ये जांचें चलाएं।
...
सभी को `200` लौटाना चाहिए (DVWA लॉगिन पर `302` रीडायरेक्ट लौटाता है)।

### स्वचालित स्मोक टेस्ट

रिपॉजिटरी में 39-पॉइंट स्मोक टेस्ट सुइट शामिल है:

```bash
./tests/smoke-test.sh ${ORIGIN_IP}
```

यह सभी 9 एप्लिकेशन, हेल्थ एंडपॉइंट्स, VAmPI पंजीकरण/लॉगिन, CSD Demo exfil राउंड-ट्रिप, DVGA GraphQL, RESTaurant Swagger, पोर्ट 8888 पर crAPI, nginx gzip, और वर्शन हाइडिंग को सत्यापित करता है।
...
### Cloud-init अभी भी चल रहा है

यदि एंडपॉइंट्स 502 या कनेक्शन अस्वीकृत लौटाते हैं, तो cloud-init अभी भी प्रोविज़निंग कर रहा हो सकता है:

```bash
ssh azureuser@${ORIGIN_IP} "cloud-init status"
```

- `status: running` -- अभी भी प्रोविज़निंग हो रही है, कुछ मिनट प्रतीक्षा करें
- `status: done` -- प्रोविज़निंग पूर्ण, Docker कंटेनर जांचें
- `status: error` -- नीचे दिए गए लॉग जांचें
...
Docker इमेज लगभग 4.7 GiB खपत करती हैं। CDN लोड टेस्टिंग के दौरान डिस्क भरने से रोकने के लिए एक्सेस लॉगिंग अक्षम है। डिफेंस-इन-डेप्थ के रूप में Logrotate कॉन्फ़िगर किया गया है (500 MiB सीमा)। डिस्क उपयोग सत्यापित करें:
...
जांचें कि कौन से कंटेनर अपनी मेमोरी सीमा के करीब पहुंच रहे हैं (OOM जोखिम):
...
यदि आवश्यक हो, तो सभी सेवाओं को पुनर्निर्माण और पुनः आरंभ करें:
