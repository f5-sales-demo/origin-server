...
cloud-init पूरा होने के लिए 5--10 मिनट का समय देने के बाद ये जाँचें चलाएँ।
...
रिपॉजिटरी में 39-पॉइंट स्मोक टेस्ट सूट शामिल है:

```bash
./tests/smoke-test.sh ${ORIGIN_IP}
```

यह सभी 9 एप्लिकेशन, हेल्थ एंडपॉइंट्स, VAmPI रजिस्ट्रेशन/लॉगिन, CSD Demo exfil राउंड-ट्रिप, DVGA GraphQL, RESTaurant Swagger, पोर्ट 8888 पर crAPI, nginx gzip, और वर्शन हाइडिंग को सत्यापित करता है।
...
यदि एंडपॉइंट्स 502 या कनेक्शन रिफ्यूज्ड लौटाते हैं, तो cloud-init अभी भी प्रोविजनिंग कर रहा हो सकता है:
...
Docker इमेज लगभग 4.7 GiB उपभोग करती हैं। CDN लोड टेस्टिंग के तहत डिस्क भर जाने से रोकने के लिए एक्सेस लॉगिंग अक्षम है। Logrotate को गहन सुरक्षा (defense-in-depth) के रूप में कॉन्फ़िगर किया गया है (500 MiB सीमा)। डिस्क उपयोग सत्यापित करें:
