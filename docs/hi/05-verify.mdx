...
cloud-init को पूरा होने के लिए 5--10 मिनट का समय देने के बाद ये जाँचें चलाएँ।
...
रिपॉज़िटरी में 39-पॉइंट का स्मोक टेस्ट सूट शामिल है:

```bash
./tests/smoke-test.sh ${ORIGIN_IP}
```

यह सभी 9 एप्लिकेशन, हेल्थ एंडपॉइंट, VAmPI रजिस्ट्रेशन/लॉगिन, CSD Demo exfil राउंड-ट्रिप, DVGA GraphQL, RESTaurant Swagger, पोर्ट 8888 पर crAPI, nginx gzip, और वर्शन हाइडिंग को मान्य करता है।
...
यदि एंडपॉइंट 502 या कनेक्शन रिफ्यूज़्ड लौटाते हैं, तो cloud-init अभी भी प्रावधान कर रहा हो सकता है:

```bash
ssh azureuser@${ORIGIN_IP} "cloud-init status"
```

- `status: running` -- अभी भी प्रावधान हो रहा है, कुछ मिनट प्रतीक्षा करें
- `status: done` -- प्रावधान पूर्ण, Docker कंटेनर जाँचें
...
Docker इमेज लगभग 4.7 GiB स्थान लेती हैं। CDN लोड टेस्टिंग के दौरान डिस्क भरने से रोकने के लिए एक्सेस लॉगिंग अक्षम है। Logrotate को डिफेंस-इन-डेप्थ के रूप में कॉन्फ़िगर किया गया है (500 MiB सीमा)। डिस्क उपयोग सत्यापित करें:
...
उन कंटेनरों की जाँच करें जो अपनी मेमोरी सीमा के करीब पहुँच रहे हैं (OOM जोखिम):
...
यदि आवश्यक हो, तो सभी सेवाओं को पुनर्निर्मित और पुनः प्रारंभ करें:
