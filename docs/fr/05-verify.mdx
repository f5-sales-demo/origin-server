...
title: Vérifier
description: >-
  Tests smoke curl pour les neuf points de terminaison de l'application,
  vérifications de l'état de santé des conteneurs Docker, vérification du statut
  nginx, inspection des journaux cloud-init et étapes de dépannage courantes
sidebar:
  order: 5
i18n:
