...
title: Verificar
description: >-
  Pruebas de humo con curl para los nueve endpoints de la aplicación,
  comprobaciones de salud de contenedores Docker, verificación del estado de
  nginx, inspección de registros de cloud-init y pasos comunes de resolución de
  problemas
sidebar:
  order: 5
i18n:
